...
SRC_URI="http://projects.vdr-developer.org/attachments/download/311/${MY_P}.tgz"
...
src_prepare() {
	epatch "${FILESDIR}/vdr-burn-0.2.0_beta4-makefile.diff"
	epatch "${FILESDIR}/vdr-burn-0.2.0_beta4-gentoo-projectx.diff"
	epatch "${FILESDIR}/vdr-burn-0.2.0_beta4-gentoo-paths.diff"
	epatch "${FILESDIR}/vdr-burn-0.2.0_beta4-setdefaults-V2.diff"
