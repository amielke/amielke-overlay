...
src_prepare() {
	...
	epatch "${FILESDIR}/Convert-frame-region-handling-to-cairo-regions.patch"
	epatch "${FILESDIR}/Only-shadow-ARGB-windows-with-a-frame-outside-the-.patch"
	epatch "${FILESDIR}/Fixes-for-ARGB-window-shadows-patch-squash.patch"
}
